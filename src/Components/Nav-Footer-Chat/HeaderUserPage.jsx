    ...
    <div>
      ...
      >
        ...
        <nav className="flex-grow flex justify-center space-x-16 tracking-widest uppercase">
          ...
          {token ? (
            ...
            <div className="relative">
              ...
              {isDropdownOpen && (
                <div
                  className="absolute mt-1 bg-white bg-opacity-20 border border-[#543310] rounded-lg p-1 flex items-center justify-center"
                  style={{
                    width: "100px",
                    height: "35px",
                ...
                >
                  <a
                    href="#register"
                    className="block text-center rounded hover:bg-orange-500 hover:bg-opacity-10 transition duration-150 w-full"
        ...
        <div className="flex items-center space-x-4 mr-4">
          <div className="relative">
            <span
              className=" uppercase tracking-wider cursor-pointer hover:text-gray-300 border-[#543310] border rounded-lg p-2"
            ...
            {isProfileDropdownOpen && (
              <div
                className="absolute mt-3 bg-white bg-opacity-20 border border-[#543310] rounded-lg p-1"
                style={{
                  width: "80px",
