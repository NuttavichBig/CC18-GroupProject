...
function PromotionHomePage() {
  ...
  return (
    <div className="text-center py-6">
      <h2 className="text-2xl font-semibold mb-6 text-[#543310]">Promotion</h2>
        ...
        {promotions.length >= 1 && (
          <div className="bg-[#fef6e4] rounded-lg shadow-lg overflow-hidden flex flex-col w-64">
            ...
            <div className="p-4">
              ...
              <button className="bg-gradient-to-t from-orange-400 to-orange-500 text-white p-2 rounded-lg mt-4">
                MORE
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4">
          {promotions.length >= 2 && (
            <div className="bg-[#fef6e4] rounded-lg shadow-lg overflow-hidden w-44">
              ...
              />
              <div className="p-4 text-sm text-[#543310]">
                {promotions[1].name}
              </div>
            </div>
          )}
