          ...
          >
            ...
            >
              <img
                src={promo.img}
                alt="Promotion"
                className="w1/2 h-full object-cover rounded-l-lg"
              />
              <div className="flex flex-col justify-center items-center w-1/2 p-4 text-center">
                ...
                <p className="text-gray-600 py-4">{promo.name}</p>
                <button
                  className="shadow-lg bg-gradient-to-t from-orange-400 to-orange-600 text-white p-1 outline-none border-none transition-transform duration-150 rounded-lg overflow-hidden hover:scale-110"
                  onClick={(e) => {
                    e.stopPropagation();
                    openModal(promo);
                  }}
