        ...
        <table className="text-center w-full mt-4 border-collapse border-2 border-[#543310]">
          <thead>
            <tr className="bg-[#AF8F6F]">
              ...
              <th className="border-2 border-[#543310] p-2">CONTENT</th>
              <th className="border-2 border-[#543310] p-2">USERNAME</th>
              <th className="border-2 border-[#543310] p-2">HOTEL NAME</th>
              <th className="border-2 border-[#543310] p-2">BOOKING NO.</th>
              <th className="border-2 border-[#543310] p-2">RATING</th>
              <th className="border-2 border-[#543310] p-2">MORE IMAGE</th>
              <th className="border-2 border-[#543310] p-2">DELETE</th>
            </tr>
          </thead>
          <tbody>
            {reviews.map((review) => (
              <tr key={review.id} className="bg-[#F8F4E1]">
                <td className="border-2 border-[#543310] p-2">{review.id}</td>
